---
kind: method
id: M:Autodesk.Revit.DB.Document.Export(System.String,System.String,Autodesk.Revit.DB.STLExportOptions)
zh: 导出、输出
source: html/fc32cc69-4691-e62c-61e3-57cf20dd9edf.htm
---
...
- **name** (`System.String`) - Indicates the name of the STL file to export. If it doesn't end with ".stl", this extension will be added automatically.
 The name cannot contain any of the following characters: \/:*?"<>|. Empty name is not acceptable.
- **options** (`Autodesk.Revit.DB.STLExportOptions`) - Various options applicable to the STL format.
