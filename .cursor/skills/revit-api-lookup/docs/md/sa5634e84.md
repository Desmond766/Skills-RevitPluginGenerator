---
kind: method
id: M:Autodesk.Revit.DB.Plumbing.Pipe.Create(Autodesk.Revit.DB.Document,Autodesk.Revit.DB.ElementId,Autodesk.Revit.DB.ElementId,Autodesk.Revit.DB.Connector,Autodesk.Revit.DB.XYZ)
zh: 创建、新建、生成、建立、新增
source: html/cd3ebfff-86e1-f101-51ef-6af629dc01d9.htm
---
...
- **levelId** (`Autodesk.Revit.DB.ElementId`) - The level id for the new pipe.
- **startConnector** (`Autodesk.Revit.DB.Connector`) - The first connector where the new pipe starts.
- **endPoint** (`Autodesk.Revit.DB.XYZ`) - The second point of the new pipe.
