---
kind: method
id: M:Autodesk.Revit.DB.IUpdater.Execute(Autodesk.Revit.DB.UpdaterData)
source: html/47eb6270-6c7b-f683-49c9-2bc62bd4f5ed.htm
---
# Autodesk.Revit.DB.IUpdater.Execute Method
...
## Parameters
- **data** (`Autodesk.Revit.DB.UpdaterData`) - Provides all necessary data needed to perform the update, including the document and information about
