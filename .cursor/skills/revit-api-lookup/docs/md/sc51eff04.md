---
kind: method
id: M:Autodesk.Revit.DB.RevitLinkType.Reload
source: html/86830eb9-5ddb-c342-fddd-6963e5c03564.htm
---
# Autodesk.Revit.DB.RevitLinkType.Reload Method
...
If the link is currently loaded, Revit must unload
 ...
 that were explicitly started must be finished prior to calling this method. This function is identical to RevitLinkType.Load() and is included for
 convenience.
