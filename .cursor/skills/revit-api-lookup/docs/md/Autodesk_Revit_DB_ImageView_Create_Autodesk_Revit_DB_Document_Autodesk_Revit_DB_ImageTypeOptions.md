---
kind: method
id: M:Autodesk.Revit.DB.ImageView.Create(Autodesk.Revit.DB.Document,Autodesk.Revit.DB.ImageTypeOptions)
zh: 创建、新建、生成、建立、新增
source: html/dfddb228-6cff-980f-b2af-f9812e6c2d63.htm
---
# Autodesk.Revit.DB.ImageView.Create Method
...
## Parameters
- **document** (`Autodesk.Revit.DB.Document`) - The document in which to create the view.
