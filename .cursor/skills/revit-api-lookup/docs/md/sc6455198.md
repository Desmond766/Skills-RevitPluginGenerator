---
kind: method
id: M:Autodesk.Revit.DB.Ceiling.Create(Autodesk.Revit.DB.Document,System.Collections.Generic.IList{Autodesk.Revit.DB.CurveLoop},Autodesk.Revit.DB.ElementId,Autodesk.Revit.DB.ElementId,Autodesk.Revit.DB.Line,System.Double)
zh: 创建、新建、生成、建立、新增
source: html/62090c44-95e6-b8bd-3c60-ff00b5583b43.htm
---
...
- **slopeArrow** (`Autodesk.Revit.DB.Line`) - A line used to control the slope angle of the Ceiling. It must be horizontal.
- **slope** (`System.Double`) - The slope angle.
