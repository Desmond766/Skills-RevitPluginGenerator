---
kind: method
id: M:Autodesk.Revit.DB.Document.Link(System.String,Autodesk.Revit.DB.SATImportOptions,Autodesk.Revit.DB.View)
zh: 链接模型、链接
source: html/c3629b13-f58b-78f3-1a81-29340774199a.htm
---
...
## Parameters
- **file** (`System.String`) - Full path of the file to link. File must exist and must be a valid SAT file.
