---
kind: method
id: M:Autodesk.Revit.DB.Curve.CreateOffset(System.Double,Autodesk.Revit.DB.XYZ)
zh: 曲线
source: html/450217f3-c0b5-42af-3a05-376ae383d28a.htm
---
# Autodesk.Revit.DB.Curve.CreateOffset Method
...
## Parameters
- **offsetDist** (`System.Double`) - The signed distance that controls the offset.
- **referenceVector** (`Autodesk.Revit.DB.XYZ`) - A reference vector to define the offset direction.
...
as specified in detail below. We plan to update this function to have a more consistent and understandable behavior.
 ...
 as if you are walking along the curve with your body aligned to the reference vector. For Arc and Ellipse, the right direction is defined relative to the axis of the arc or ellipse
