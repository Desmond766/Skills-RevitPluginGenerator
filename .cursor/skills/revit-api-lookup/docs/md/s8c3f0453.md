---
kind: method
id: M:Autodesk.Revit.ApplicationServices.Application.OpenDocumentFile(Autodesk.Revit.DB.ModelPath,Autodesk.Revit.DB.OpenOptions,Autodesk.Revit.DB.IOpenFromCloudCallback)
source: html/dcdca59a-635c-a6ca-8378-b1e6bb372101.htm
---
...
- **openFromCloudCallback** (`Autodesk.Revit.DB.IOpenFromCloudCallback`) - The interface implementation to use when opening a cloud document. Only used for opening cloud model.
