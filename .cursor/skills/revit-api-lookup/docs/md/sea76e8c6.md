---
kind: method
id: M:Autodesk.Revit.DB.Document.Save(Autodesk.Revit.DB.SaveOptions)
zh: 文档、文件
source: html/e567811b-4502-e938-c956-dce0e5cc17c2.htm
---
...
## Parameters
- **options** (`Autodesk.Revit.DB.SaveOptions`) - Options to control the Save operation.
...
## Exceptions
- **Autodesk.Revit.Exceptions.ArgumentException** - options.PreviewViewId is not valid for generation of a preview.
