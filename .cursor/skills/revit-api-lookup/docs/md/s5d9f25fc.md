---
kind: method
id: M:Autodesk.Revit.DB.Document.Import(System.String,Autodesk.Revit.DB.OBJImportOptions,Autodesk.Revit.DB.View)
zh: 导入
source: html/96eda242-d5f0-f72f-87fc-5400e70b7903.htm
---
...
## Parameters
- **file** (`System.String`) - Full path of the file to import. File must exist and must be a valid OBJ file.
- **options** (`Autodesk.Revit.DB.OBJImportOptions`) - Various import options applicable to the OBJ format. If Nothing nullptr a null reference ( Nothing in Visual Basic) , all options will be set to their respective default values.
...
## Exceptions
- **Autodesk.Revit.Exceptions.ArgumentException** - Not a valid file for OBJ import (.obj files are valid).
 -or-
