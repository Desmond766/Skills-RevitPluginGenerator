---
kind: method
id: M:Autodesk.Revit.DB.Document.Import(System.String,Autodesk.Revit.DB.ImportOptions3DM,Autodesk.Revit.DB.View)
zh: 导入
source: html/64303015-53a6-3bde-e8ee-838d927956f0.htm
---
...
## Parameters
- **file** (`System.String`) - Full path of the file to import. File must exist and must be a valid 3DM file.
