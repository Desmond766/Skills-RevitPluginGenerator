---
kind: method
id: M:Autodesk.Revit.UI.UIApplication.OpenAndActivateDocument(Autodesk.Revit.DB.ModelPath,Autodesk.Revit.DB.OpenOptions,System.Boolean)
source: html/e74b17da-9e81-900e-c8df-a63718e4e82b.htm
---
...
- **Autodesk.Revit.Exceptions.FileAccessException** - When file cannot be opened in Revit LT because it was last saved in a version of Revit prior to 8.1. when file has an invalid extension. Try changing the file's extension and opening it again. when file was saved by an application that was not developed or licensed by Autodesk.
