---
kind: method
id: M:Autodesk.Revit.DB.ExternalService.ExternalServiceRegistry.RegisterService(Autodesk.Revit.DB.ExternalService.ISingleServerService,System.Guid,Autodesk.Revit.DB.ExternalService.ExternalServiceOptions)
source: html/f6721f5b-c8e5-f4a0-56b1-ee28321fa09e.htm
---
...
- **defaultServerId** (`System.Guid`) - Id of the server that will become the service's default server (once the server is registered).
...
- **Autodesk.Revit.Exceptions.ArgumentException** - The given service is not a valid implementation of ISingleServerService.
 ...
 -or-
 The given Id is not a valid GUID value.
 -or-
 A mandatory service should support activation.
