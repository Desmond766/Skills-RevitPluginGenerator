# Sample Snippet: MEP_FittingOffsetFour

Source project: `existingCodes\品成插件源代码\机电\MEP_FittingOffsetFour\MEP_FittingOffsetFour`
    ...
    System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location));
            ...
            try
            {
                while (true)
                {
                    ...
                    r4 = sel.PickObject(ObjectType.Element, new MEPCurveSelectionFilter(), "选择机电管线");
