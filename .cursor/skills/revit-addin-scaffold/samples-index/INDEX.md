...
Auto-generated catalog of 197 Revit plug-ins under `existingCodes/`. Each entry summarizes signals mined from the source (Transaction labels, TaskDialog titles, BuiltInCategory / BuiltInParameter references, UI framework, integrations) and links to a compact source snippet when available.
...
**Search** (agents should always `rg` this file first before reading snippets or optional full source).
