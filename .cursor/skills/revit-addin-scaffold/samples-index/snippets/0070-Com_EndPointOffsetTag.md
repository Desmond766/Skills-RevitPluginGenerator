# Sample Snippet: Com_EndPointOffsetTag

Source project: `existingCodes\品成插件源代码\通用\Com_EndPointOffsetTag\Com_EndPointOffsetTag`
...
namespace Com_EndPointOffsetTag
{
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            using (Transaction trans = new Transaction(doc, "Creat IndependentTag"))
            {
                ...
                foreach (Reference reference in list)
                {
                    ...
                    {
                        IndependentTag tag = doc.Create.NewTag(view, doc.GetElement(reference), true, tagMode, tagOrientation, endPoint);
                        if (null == tag)
                        {
                        ...
                        XYZ headerPnt = endPoint + new XYZ(1.0, 1.0, 0.0);
