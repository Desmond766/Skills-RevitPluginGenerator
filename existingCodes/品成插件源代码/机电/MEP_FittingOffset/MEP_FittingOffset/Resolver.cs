...
namespace MEP_FittingOffset
{
    ...
    class Resolver
    {
        ...
        public void Resolve(Reference r1, Reference r2, Reference r3)
        {
            // 原管线
            ...
            #region 管道
            if (mepCurve1 is Pipe && mepCurve2 is Pipe && mepCurve3 is Pipe)
            {
            ...
            #region 风管
            if (mepCurve1 is Duct && mepCurve2 is Duct && mepCurve3 is Duct)
            {
            ...
            #region 桥架
            if (mepCurve1 is CableTray && mepCurve2 is CableTray && mepCurve3 is CableTray)
            {
                ...
                CableTray side3 = CableTray.Create(m_doc, cableTray2.GetTypeId(), offsetPoint3, pickPoint3, levelId);
            ...
            #region 线管
            if (mepCurve1 is Conduit && mepCurve2 is Conduit && mepCurve3 is Conduit)
            {
                ...
                // 【3+】创建终点处2管道
                Conduit midConduit = Conduit.Create(m_doc, conduit2.GetTypeId(), middlePoint2, pickPoint3, levelId);
                if (null != midConn)
                {
